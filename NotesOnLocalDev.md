...
Make sure the local canister id for the deployed Bebb Protocol canister is be2us-64aaa-aaaaa-qaabq-cai (required by this project to make the calls on the local replica)
