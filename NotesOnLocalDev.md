...
Deploy this project's canisters
...
Make sure the local canister id for the deployed Bebb Protocol canister is r7inp-6aaaa-aaaaa-aaabq-cai (required by this project to make the calls on the local replica)
